...
/**
 * DTO pour mettre à jour un service de coiffure existant.
 */
@Schema(description = "Données pour mettre à jour un service de coiffure")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class ServiceUpdateDTO {
    ...
    @Schema(description = "Nom du service", example = "Coupe homme premium")
    @Size(min = 2, max = 100, message = "Le nom doit contenir entre 2 et 100 caractères")
    private String name;

    @Schema(description = "Description détaillée du service", example = "Coupe avec consultation personnalisée")
    @Size(max = 1000, message = "La description ne peut pas dépasser 1000 caractères")
    private String description;

    @Schema(description = "Prix du service en euros", example = "30.00")
    ...
    @Schema(description = "Durée du service en minutes", example = "45")
    ...
    @Schema(description = "Points de fidélité accordés", example = "15")
    ...
    @Schema(description = "ID de la catégorie", example = "2")
